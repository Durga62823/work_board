    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-8xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 cursor-pointer gap-4">
          <Card className="relative overflow-hidden border-2 border-transparent bg-card backdrop-blur-sm hover:border-primary hover:ring-2 hover:ring-primary/50 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link href="/employee/my-work">
              <Card className="group relative overflow-hidden border-2 border-transparent bg-card hover:border-primary hover:ring-2 hover:ring-primary/50 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer">
        ...
        <Card className="border-border bg-card backdrop-blur-sm shadow-lg">
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex items-center justify-between p-4 rounded-xl bg-primary/10 border-2 border-transparent hover:border-primary hover:shadow-md transition-all group cursor-pointer">
