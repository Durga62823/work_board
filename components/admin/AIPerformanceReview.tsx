  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium mb-1">On-Time Delivery %</label>
          <input
            type="number"
        ...
        <div className="space-y-4 mt-6">
          <Card className="p-4 bg-indigo-50">
            <div className="flex items-center justify-between mb-4">
              <h4 className="font-semibold text-lg">Performance Review: {formData.name}</h4>
              <div className="flex items-center gap-2">
                <Star className="h-5 w-5 text-yellow-500 fill-yellow-500" />
                <span className="text-2xl font-bold text-indigo-600">{result.overallScore}/10</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card className="p-4">
              <h5 className="font-semibold mb-2 text-orange-700">Areas for Improvement</h5>
              <ul className="space-y-1">
                {result.areasForImprovement?.map((area: string, idx: number) => (
                  <li key={idx} className="text-sm flex items-start gap-2">
          ...
          <Card className="p-4">
            ...
            <ul className="space-y-1">
              {result.accomplishments?.map((accomplishment: string, idx: number) => (
                <li key={idx} className="text-sm flex items-start gap-2">
