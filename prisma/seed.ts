...
async function seed() {
  try {
    ...
    await prisma.codeReview.createMany({
      data: [
        // Approved PRs
        {
          ...
          mergedAt: new Date("2024-12-05"),
        },
        {
          prUrl: "https://github.com/example/pr/120",
          prTitle: "feat: Dashboard UI improvements",
          authorId: emp1.id,
          reviewerId: lead1.id,
          status: "approved",
          linesChanged: 320,
          ...
          mergedAt: new Date("2024-12-02"),
        },
        {
          prUrl: "https://github.com/example/pr/127",
          prTitle: "feat: Add pagination to task list",
          authorId: emp2.id,
          reviewerId: lead1.id,
          status: "approved",
          linesChanged: 180,
        ...
        {
          prUrl: "https://github.com/example/pr/128",
          prTitle: "fix: Performance optimization for large datasets",
          authorId: emp4.id,
          reviewerId: lead2.id,
          status: "approved",
          linesChanged: 520,
        ...
        {
          prUrl: "https://github.com/example/pr/129",
          prTitle: "feat: Add caching layer for API responses",
          authorId: emp1.id,
          reviewerId: lead1.id,
          status: "changes_requested",
          linesChanged: 280,
        ...
        {
          prUrl: "https://github.com/example/pr/130",
          prTitle: "refactor: Improve error handling in auth module",
          authorId: emp3.id,
          reviewerId: lead1.id,
          status: "changes_requested",
          linesChanged: 410,
        ...
        {
          prUrl: "https://github.com/example/pr/131",
          prTitle: "feat: Add real-time notifications",
          authorId: emp2.id,
          reviewerId: lead1.id,
          status: "pending",
          linesChanged: 650,
        ...
        {
          prUrl: "https://github.com/example/pr/132",
          prTitle: "feat: Implement search functionality",
          authorId: emp5.id,
          reviewerId: lead2.id,
          status: "pending",
          linesChanged: 390,
        ...
        {
          prUrl: "https://github.com/example/pr/133",
          prTitle: "test: Add unit tests for auth service",
          authorId: emp4.id,
          reviewerId: lead2.id,
          status: "pending",
          linesChanged: 220,
        ...
        // More approved PRs for metrics
        {
          prUrl: "https://github.com/example/pr/115",
          prTitle: "feat: User profile page",
          authorId: emp2.id,
          reviewerId: lead1.id,
          status: "approved",
          linesChanged: 380,
          ...
          mergedAt: new Date("2024-11-26"),
        },
        {
          prUrl: "https://github.com/example/pr/116",
          prTitle: "fix: Login redirect issue",
          authorId: emp3.id,
          reviewerId: lead1.id,
          status: "approved",
          linesChanged: 120,
          ...
          mergedAt: new Date("2024-11-28"),
        },
        {
          prUrl: "https://github.com/example/pr/117",
          prTitle: "feat: Database connection pooling",
          authorId: emp4.id,
          reviewerId: lead2.id,
          status: "approved",
          linesChanged: 290,
          ...
          reviewedAt: new Date("2024-11-29"),
          mergedAt: new Date("2024-11-29"),
        },
        {
          prUrl: "https://github.com/example/pr/118",
          prTitle: "feat: Analytics dashboard charts",
          authorId: emp1.id,
          reviewerId: lead1.id,
          status: "approved",
          linesChanged: 540,
          ...
          reviewedAt: new Date("2024-11-30"),
          mergedAt: new Date("2024-11-30"),
        },
      ],
    });

    console.log("✅ Created 15 code reviews\n");
    ...
    await prisma.technicalMetric.createMany({
      data: [
        // Current Month Metrics - Frontend Team
        {
          teamId: frontendTeam.id,
          ...
          unit: "hours",
          period: "weekly",
          periodStart: new Date("2025-12-22"),
          periodEnd: new Date("2025-12-29"),
        },
        {
          teamId: frontendTeam.id,
        ...
        },
        {
          ...
          unit: "minutes",
          period: "daily",
          periodStart: new Date("2025-12-28"),
          periodEnd: new Date("2025-12-29"),
        },
        {
          teamId: frontendTeam.id,
        ...
        },
        {
          ...
          unit: "count",
          period: "sprint",
          periodStart: new Date("2025-12-16"),
          periodEnd: new Date("2025-12-30"),
        },
        {
          teamId: frontendTeam.id,
        ...
        // Previous weeks for trend data - Frontend Team
        {
          teamId: frontendTeam.id,
          metricType: "pr_merge_time",
          value: 22.3,
        ...
        // Week before last
        {
          ...
          unit: "hours",
          period: "weekly",
          periodStart: new Date("2025-12-08"),
          periodEnd: new Date("2025-12-14"),
        },
        {
          teamId: frontendTeam.id,
          metricType: "code_review_time",
    ...
    console.log("✅ Created 30 technical metrics\n");
    ...
    console.log("  - 4 Sprints (1 Active, 1 Planning, 2 Completed)");
    console.log("  - 16 Tasks (6 assigned to your account)");
    console.log("  - 15 Code Reviews (4 Pending, 3 Changes Requested, 8 Approved)");
    console.log("  - 30 Technical Metrics (covering all KPIs with trend data)");
